...
import { getExperiencesAction, getUserIdAction } from "../redux/actions";
...
const ProfiliCercati = () => {
  ...
  const esperienza = useSelector((state) => {
    return state.listExperience.experience;
  });
  const dispatch1 = useDispatch();
  useEffect(() => {
    if (profiloCercato && profiloCercato._id) {
      dispatch1(getExperiencesAction(profiloCercato._id));
    }
  }, [profiloCercato]);
  ...
  return (
    <>
      <Container className=" row-border">
        <Row>
          <Col>
